            ...
            <div className="flex flex-col mt-6 gap-x-8 gap-y-20 lg:flex-row">
              <div className="lg:w-full lg:max-w-2xl lg:flex-auto">
                <p className="text-xl leading-8 text-gray-300">
                  At Copperlode Brewery Co., our mission is to craft the finest
                  beers that embody the spirit of Far North Queensland.
                </p>
                <div className="max-w-xl mt-10 text-base leading-7 text-gray-400">
                  <p>
                    We strive to create unique, smashable brews inspired by our
                    pristine water source and the tropical beauty of the region.
                    With relentless dedication, we aim to share our passion for
                    craft beer, enriching the lives of beer enthusiasts near and
                    far.
                  </p>
                  {/* <p className="mt-10">
        ...
        <div className="px-6 mx-auto mt-32 max-w-7xl sm:mt-48 lg:px-8">
          <div className="max-w-2xl mx-auto lg:mx-0">
            ...
            <p className="mt-6 text-lg leading-8 text-gray-300">
              ...
              exceptional beers with care and dedication, showcasing the unique
